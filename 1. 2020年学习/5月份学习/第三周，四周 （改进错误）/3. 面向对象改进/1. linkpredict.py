...
class DataClassification(object):
    ...
    def __init__(self, k, calss):
        ...
        self.color_map = {0: 'r', 1: 'g', 2: 'yellow', 3: 'black'}
    ...
    def draw_graph(self):
        ...
        node_color = []
        color_list = [self.color_map.get(self.g.nodes[node]['labels']) for node in self.g.nodes()]
        nx.draw(self.g, pos, node_color=color_list, node_size=200)
        plt.show()
        print(len(self.g.nodes()))
        print(len(self.g.edges()))
