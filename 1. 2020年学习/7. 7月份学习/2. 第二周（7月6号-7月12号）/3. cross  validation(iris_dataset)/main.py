...
class DataClassification(object):
    ...
    def get_subgraph(self):
        ...
        for n in range(num):
            ...
            count2 = 0
            for m in G.nodes():
                #print(self.X_train[int(m)])    #因为节点是字符串，所以必须转换位整型，才能知道数据
    ...
    def predict(self, X_test, Y_test=[]):
        ...
        for index, instance in enumerate(self.X_test):
            ...
            BN.node_insert(self.G, self.k, nbrs, instance, insert_node_id)
...
if __name__ == '__main__':
    ...
    DC = DataClassification(Y_test, k=2, num_class=3)  # 选择最优的K=2传入模型
