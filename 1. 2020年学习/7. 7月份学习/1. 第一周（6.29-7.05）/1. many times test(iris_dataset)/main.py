...
class DataClassification(object):
    ...
    def predict(self, X_test, Y_test):
        ...
        for index, instance in enumerate(self.X_test):
            ...
            result = self.classification(insert_node_id, int(self.Y_test[index]), result)
            print("=" * 100)
    ...
    def classification(self, insert_node_id, label, result):
...
if __name__ == '__main__':
    ...
    """
    best_knn = DataClassification(n_neighbors=3)  # 选择最优的K=3传入模型
