    ...
    def classification(self, insert_node_id, label):
        ...
        if count0 == len(adj):
            ...
            if count0 >= 0 and count0 < len(adj):
                ...
                #draw_graph(self.G0)
                measures0 = calculate_measure(self.G0, insert_node_id)  # new subgraph self.G0 measures
                print("measures0:", measures0)

                #V1, V2 = np.array(self.net0_measure[len(self.net0_measure) - 1]), np.array(measures0)
                measures.append(measures0)
            ...
            if count1 >= 0 and count1 < len(adj):
                ...
                for n in neighbor:
                    ...
                    self.G.add_edge(str(insert_node_id), n)
                self.get_subgraph()
                measures1 = calculate_measure(self.G1, insert_node_id)
                print("measures1:", measures1)
                measures.append(measures1)
            ...
            label = int(measures.index(max(measures)))
