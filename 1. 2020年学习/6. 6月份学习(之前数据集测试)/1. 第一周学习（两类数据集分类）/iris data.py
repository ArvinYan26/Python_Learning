...
class DataClassification(object):
    ...
    def get_iris(self):
        ...
        train_data, train_target, X_test, Y_test  = split_data(iris_data, iris_target, X_train1, Y_train1, train_data, train_target)
    ...
    def calculate_measure(self, G):
        ...
        measures.append(degree_centrality)

        #7.度中心性
        closenses_centrality = nx.closeness_centrality(G)
        closenses_centrality = round(closenses_centrality, 3)
        measures.append(closenses_centrality)

        #8. betweenness_centrality 介数中心性
        betweenness_centrality = nx.betweenness_centrality(G)
        betweenness_centralit = round(betweenness_centrality, 3)
        measures.append(betweenness_centrality, 3)
        """
