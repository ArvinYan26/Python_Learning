...
min_value, max_value, steps = 80, 200, 8
...
def binary_image(image):
    ...
    for i in Threshold:
        ...
        demen = fractal_dimension(b_img, i)
        x.append(demen)
    return x
...
def convertjpg(pngfile, data):
    ...
    for i in Threshold:
        ...
        demen = fractal_dimension(b_img, i)
        demension.append(demen)
    data.append(demension)
...
data1 = np.array(viral_pneumonia)
data2 = np.array(covid_19)
...
save.to_csv(r"C:/Users/Yan/Desktop/CovidData_Dall-c.csv", index=False, header=True)
