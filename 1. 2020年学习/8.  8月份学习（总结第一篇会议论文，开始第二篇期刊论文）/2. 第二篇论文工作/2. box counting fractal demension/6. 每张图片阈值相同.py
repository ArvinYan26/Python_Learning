...
plt.plot(Threshold,D[0], color="#ff0000", label="normal0")
plt.plot(Threshold,D[1], color="#ff005f", label="normal1")
plt.plot(Threshold,D[2], color="#ff0087", label="normal2")
plt.plot(Threshold,D[3], color="#ff00af", label="normal3")
