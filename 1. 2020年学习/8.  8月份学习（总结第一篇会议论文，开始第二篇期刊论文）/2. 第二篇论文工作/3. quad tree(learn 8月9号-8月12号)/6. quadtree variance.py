...
class Solution:
    def construct(self, grid, all_grid):
        ...
        if stddv <= 3:  # 均方差等于零，那么就代表已经分到单个像素级别了，或者stddv <= 0.8, 分到2*2，就不再划分
            root.isLeaf = True
...
if __name__ == '__main__':
    ...
    img1 = cv2.imread(r"C:\Users\Yan\Desktop\COVID-19\COVID-19\COVID-19 (2).png", 0)
    ...
    all_grid = []
    all_grid1 = []
    root, all_grid = S.construct(img, all_grid)
    root1, all_grid1 = S.construct(img1, all_grid1)
    #print(all_grid)
    y = []
