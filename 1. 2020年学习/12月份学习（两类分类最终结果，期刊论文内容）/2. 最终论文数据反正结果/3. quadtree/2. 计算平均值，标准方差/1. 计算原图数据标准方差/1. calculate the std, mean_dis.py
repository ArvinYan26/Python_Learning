...
def calculate(dataset):
    ...
    adj_matrix = data_preprcess(adj_matrix)
...
if __name__ == '__main__':
    ...
    n, c = get_data(percent=0.9)
    #x_train, x_test, y_train, y_test, dic = data_segmentation(x, y, p=0.9)
    m_dis0, st0 = calculate(n)
    m_dis1, st1 = calculate(c)

    print("normal:", m_dis0, st0)
    print("covid-19:", m_dis1, st1)
