...
def get_data(percent):
    ...
    #读取图片数据，转化为矩阵
    count0 = 0
    for pngfile in glob.glob("C:/Users/Administrator/Desktop/COVID-19/NORMAL/*.png"):
    ...
    count1 = 0
    for pngfile in glob.glob(r"C:/Users/Administrator/Desktop/COVID-19/COVID-19/*.png"):
