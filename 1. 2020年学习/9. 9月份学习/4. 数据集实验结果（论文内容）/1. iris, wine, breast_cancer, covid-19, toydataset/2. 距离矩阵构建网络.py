...
class NetworkBaseModel():
    ...
    def predict(self, x: np.ndarray):
        ...
        for item in x:  # 遍历测试数据
            ...
            for ith_class in range(self.num_classes):
                ...
                edge_idxs = list(np.argwhere(dis_matrix[0] < np.min(self.mean_dis_list[ith_class])))
    ...
    def calculate_net_measures(self, net):
        ...
        return [average_degree, effic, den]
...
if __name__ == '__main__':
    ...
    #df = pd.read_csv(r"C:\Users\Yan\Desktop\CovidData_n_min_8_512.csv")
